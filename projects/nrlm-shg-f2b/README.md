...
This repo contains the scraper for extracting the F2b report of NRLM SHGs. The F2b report contains information on CIF distributed to SHGs at SHG level. This scraper is built as part of the INFUSION project under BIPP.
