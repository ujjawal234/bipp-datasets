...
lgd = pd.read_csv("./data/external/ac_gp_mapping_24_01_2022.csv")
...
lgd = lgd[
    [
        ...
        "block_lgd_code",
        "block_name",
        "rural_localbody_code",
        "rural_localbody_name",
    ]
]
...
lgd["rural_localbody_name"] = lgd["rural_localbody_name"].str.upper()
...
lgd["state_dist_block_panch"] = (
    ...
    + lgd["district_name"]
    + lgd["block_name"]
    + lgd["rural_localbody_name"]
)

# removing duplicates and NA in panchayat names
lgd = lgd.drop_duplicates(subset="state_dist_block_panch")
lgd = lgd[~lgd["rural_localbody_name"].isna()]
...
def panchayat_lgd_mapper(path_name):
    ...
    not_lgd.to_csv("data/interim/not_panch_lgd_after_fuzzy_UP.csv", index=False)
    lgd_matched.to_csv("data/interim/panch_lgd_fuzzy_matched_UP.csv", index=False)
