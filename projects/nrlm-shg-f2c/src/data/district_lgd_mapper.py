...
in_file = interim_path.joinpath("2022_23_June.csv")
...
def lgd_master():
    ...
    def data_file_prep():
        ...
        df["state"] = df["state"].str.replace("_", " ").str.upper().str.strip()
        df["district"] = (
            df["district"].str.replace("_", " ").str.upper().str.strip()
        )
        df["block"] = df["block"].str.replace("_", " ").str.upper().str.strip()
        print(
            df[
    ...
    def dist_name_clean():
        ...
        conditions = [
            ...
            # Madhya Pradesh
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="HARDA") & (df["block"] =="PUNASA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="HARDA") & (df["block"] =="PANDHANA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="HARDA") & (df["block"] =="KHALAWA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="HARDA") & (df["block"] =="CHHAIGAON MAKHAN"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="HARDA") & (df["block"] =="BALADI KILLOD"),
            ...
            (df["state"] == "MADHYA PRADESH")
            & (df["district"] == "KHANDWA")
            & (df["block"] == "BALADI  KILLOD"),
            (df["state"] == "MADHYA PRADESH")
            & (df["district"] == "KHANDWA")
            & (df["block"] == "CHHAIGAON MAKHAN"),
            (df["state"] == "MADHYA PRADESH")
            & (df["district"] == "KHANDWA")
            & (df["block"] == "HARSUD"),
            (df["state"] == "MADHYA PRADESH")
            ...
            & (df["district"] == "KHANDWA")
            & (df["block"] == "PUNASA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="BABAI"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="BANKHEDI"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="HOSHANGABAD"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="KESLA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="PIPARIYA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="SEONI MALWA"),
            # (df['state'] == "MADHYA PRADESH") &  (df["district"] =="NARMADAPURAM") & (df["block"] =="SOHAGPUR"),
            # Meghalaya
            (df["state"] == "MEGHALAYA")
            & (df["district"] == "WEST KHASI HILLS")
            & (df["block"] == "MAIRANG"),
            # Punjab
    ...
    def fuzzy_mapper():
        ...
        df1.to_csv(
            interim_path.joinpath("2022_23_June_district_lgd_mapped.csv"),
            index=False,
        )
