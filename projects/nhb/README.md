...
This repo contains data of Integrated Cold Chain Availability Platform (ICAP) of all the states in India as well as a file containing the collated data for all the states.
